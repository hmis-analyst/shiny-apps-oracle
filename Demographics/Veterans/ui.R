      ...
      wellPanel(
        ...
        tabsetPanel(selected="Data Options",
          ...
          tabPanel("About",
            ...
            p(div(strong("Source code:"),"View on",a(href="https://github.com/hmis-analyst/shiny-apps-oracle/tree/master/Demographics/Veteran","GitHub"))),
